...
export function AdminRoom({ toggleTheme }: RoomProps) {
  ...
  async function confirmDeleteQuestion() {
    try {
      await database
        .ref(`rooms/${roomId}/questions/${currentQuestionId}`)
        .remove();
      setShowModalQuestion(false);
      setCurrentQuestionId('');
      toast.success('Esta pergunta foi removida!', {
  ...
  const modalQuestion = (
    <Modal onClick={() => setShowModalQuestion(false)}>
      <div className="modal-container">
        ...
        <div className="controls-modal">
          ...
          <Button
            ...
            style={{ background: '#E73F5D', color: '#FEFEFE' }}
          >
            Sim, excluir
          </Button>
        </div>
  ...
  const modalEncerrar = (
    <Modal onClick={() => setShowModalEncerrar(false)}>
      <div className="modal-container">
        <div className="header-modal">
          <svg
            width="48"
  ...
  const logoSvg = (
    ...
    >
      <path
        ...
        fill={titleTheme === 'light' ? '#29292E' : '#fff'}
      />
      <path
  ...
  return (
    <RoomContainer>
      <header>
        <div className="content">
          ...
          <div>
            ...
            <Button onClick={() => setShowModalEncerrar(true)} isOutlined>
              Encerrar Sala
            </Button>
            <Switch
          ...
          {questions.map((question) => {
            return (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={handleDeleteQuestion.bind(null, question.id)}
                >
      ...
      {showModalEncerrar && modalEncerrar}
    </RoomContainer>
  );
}
